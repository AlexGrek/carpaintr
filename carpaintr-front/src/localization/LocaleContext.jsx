...
const TRANSLATIONS_BASIC = {
  ua: {
    ...
    "Document title: Under construction": "У розробці",
    "Document title: Admin Area": "Адміністрування",
    "Document title: Contact Support": "Зв'язатися з підтримкою",
    "Document title: Create processor": "Створити процесор",
    "Document title: Company info": "Інформація про компанію",
    "Document title: Sign in": "Увійти",
    "Document title: Register": "Реєстрація",
    "Document title: History": "Історія",
    ...
    Test: "Тест",
    "Variants (each line is a variant)":
      "Варіанти (кожен рядок - окремий варіант)",
    Save: "Зберегти",
    Load: "Завантажити",
    Articles: "Тексти",
    Type: "Тип",
...
const detectBrowserLanguage = () => {
  ...
  const languages = [navigator.language, ...(navigator.languages || [])].map(
...
export const LocaleProvider = ({ children }) => {
  ...
  return (
    <LocaleContext.Provider
      value={{ currentLang, setLang, str, addTranslation, labels }}
    >
      {children}
    </LocaleContext.Provider>
  );
