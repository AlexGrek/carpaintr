        ...
        <div className="menu-tree">
            {items.map((item, index) => (
                <div key={index} className="menu-item-container">
                    <div
                        className={`menu-item ${item.subitems ? 'has-subitems' : ''} ${(value === item.value && value != null) ? 'selected' : ''
                            }`}
                        onClick={() => handleItemClick(item, index)}
                    >
                        <span className="menu-item-label">{item.label}</span>
                        {item.subitems && (
                            <span className={`menu-item-arrow ${expandedItem === index ? 'expanded' : ''}`}>
                                ▼
                            </span>
                        )}
                    </div>
                    ...
                    {item.subitems && (
                        <div className={`submenu ${expandedItem === index ? 'expanded' : ''}`}>
