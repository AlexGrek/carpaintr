...
registerTranslations("ua", {
  ...
  Cancel: "Скасувати",
  Confirm: "Підтвердити",
  "Reset calculation confirmation":
    "Ви впевнені, що хочете почати новий розрахунок? Всі незбережені дані будуть втрачені.",
  ...
  "Custom Template Content (HTML/Liquid)":
    "Власний вміст шаблону (HTML/Liquid)",
  "Enter custom template content here (e.g., HTML with placeholders)":
    "Введіть власний вміст шаблону тут (наприклад, HTML з плейсхолдерами)",
  ...
  "HTML preview generated successfully!":
    "HTML попередній перегляд успішно згенеровано!",
  "PDF downloaded successfully!": "PDF успішно завантажено!",
  "Generate a preview to see it here.":
    "Сформуйте попередній перегляд, щоб побачити його тут.",
