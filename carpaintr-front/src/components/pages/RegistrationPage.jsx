...
const RegistrationPage = () => {
  ...
  const handleRegistration = async () => {
    ...
    try {
      ...
      toaster.push(<Message type="success" header="Success">Registration successful! You can now log in.</Message>, { placement: 'topCenter' });
      ...
      toaster.push(<Message type="error" header="Error">{error.message}</Message>, { placement: 'topCenter' });
    } finally {
  ...
  return (
    ...
    <Container className='auth-page'>
      ...
      <Panel className='fade-in-simple' style={{ maxWidth: 400, margin: 'auto', padding: '2rem', marginTop: '8em', backgroundColor: 'white' }} bordered>
        ...
        <Form fluid>
          ...
          <Form.Group>
            ...
            <Button appearance="primary" onClick={handleRegistration} loading={loading}>
              Зареєструватися
            </Button>
          </Form.Group>
        </Form>
