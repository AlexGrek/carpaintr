...
const model = Schema.Model({
    ...
    evaluation_license_duration_days: NumberType('Duration must be a number.').isRequired('Duration is required.'),
    usage_policy: StringType().isRequired('Usage policy is required.'),
    usage_limit: NumberType('Limit must be a number.').min(1, 'Limit must be at least 1.'),
});
...
function InvitesPanel() {
    ...
    const handleGenerate = async () => {
        ...
        const requestBody = {
            ...
            evaluationLicenseDurationDays: parseInt(formValue.evaluation_license_duration_days),
            usagePolicy: formValue.usage_policy === 'UseUpToCertainLimit'
            ...
            <Content>
                        ...
                        <Panel header={<h3>Generate New Invite</h3>} bordered>
                            ...
                            >
                                <Form.Group controlId="evaluation_license_type">
                                    ...
                                    <Form.Control name="evaluation_license_type" defaultValue="Basic" />
                                ...
                                <Form.Group controlId="usage_policy">
                                    ...
                                    <Form.Control name="usage_policy" accepter={RadioGroup} inline>
                                        <Radio value="UseOnce">UseOnce</Radio>
                                        <Radio value="UseForever">UseForever</Radio>
                                        <Radio value="UseUpToCertainLimit">UseUpToCertainLimit</Radio>
                                    </Form.Control>
                                </Form.Group>
                            ...
                            {generatedInvite && (
                                ...
                                >
                                    ...
                                    <Stat>
                                            ...
                                            <Stat.Value>{JSON.stringify(generatedInvite.usagePolicy)}</Stat.Value>
                                    </Stat>
                                    </HStack>
                                </Panel>
                            )}
                ...
                <FlexboxGrid justify="center">
                    <FlexboxGrid.Item colspan={20}>
                        <Panel header={<h3>Active Invites</h3>} bordered collapsible style={{ backgroundColor: "white" }}>
                            {loading ? (
                                ...
                                >
                                    ...
                                    <Column width={160}>
                                        ...
                                        <Cell>
                                            {rowData => {
                                                ...
                                                if (rowData.usagePolicy == "UseForever") return 'Forever';
                                                if (rowData.usagePolicy.UseUpToCertainLimit) return `Use Up To ${rowData.usagePolicy.UseUpToCertainLimit}`;
                                                return 'N/A';
                                            }}
                                        </Cell>
                                    </Column>
                                    <Column width={150}>
                                        ...
                                        <Cell>
                                            {rowData => new Date(rowData.issued).toLocaleDateString()}
                                        </Cell>
                                    </Column>
                                    <Column width={150}>
                                        <HeaderCell>Used By Count</HeaderCell>
                                        <Cell>
                                            {rowData => rowData.usedBy.length}
                                        </Cell>
                                    </Column>
                                    <Column flexGrow={1}>
                                        <HeaderCell>Used By</HeaderCell>
                                        <Cell>
                                            {rowData => rowData.usedBy.join(", ")}
                                        </Cell>
                                    </Column>
                                </Table>
                            )}
