...
const CarCatalog = () => {
    ...
    return <div className="fade-in-simple">
        ...
        <SelectionInput mode="select" name={str("Make")} values={makes} labelFunction={capitalizeFirstLetter} selectedValue={selectedMake} onChange={(value) => setSelectedMake(value)} placeholder={str("Select Make")} />
        {(selectedMake != null && models != null) && <div className="fade-in-simple"><CarDataDisplay data={models} make={selectedMake} /></div>}
    </div>
}
