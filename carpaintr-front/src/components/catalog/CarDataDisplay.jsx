  ...
  const filteredAndSortedData = useMemo(() => {
    ...
    entries.sort(([nameA, carA], [nameB, carB]) => {
      switch (sortMode) {
        ...
        case "class":
          return (
            (classOrder[carA.euro_class] || 99) -
            (classOrder[carB.euro_class] || 99)
          );
        case "suv-first":
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text as="small">
            <Trans>Total</Trans>: <b>{filteredAndSortedData.length}</b>
          </Text>
        </div>
      </div>
              ...
              >
                ...
                >
                  ...
                  {carData.is_suv && (
                    <Badge
                      content="SUV"
                      style={{ backgroundColor: "#e67e22", fontSize: "0.7rem" }}
                    />
                  )}
                </div>
                  ...
                  {formatPrice(
                    Math.round(
                      filteredAndSortedData.reduce(
                        (sum, [, car]) => sum + car.estimated_price,
                        0,
                      ) / filteredAndSortedData.length,
                    ),
                  )}
