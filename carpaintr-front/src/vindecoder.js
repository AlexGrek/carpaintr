...
const wmiData = {
    // Japan
    'JA': 'Isuzu', 'JC': 'Isuzu', 'JF': 'Fuji Heavy Industries (Subaru)', 'JH': 'Honda', 'JK': 'Kawasaki', 'JM': 'Mazda', 'JN': 'Nissan', 'JS': 'Suzuki', 'JT': 'Toyota',
    // Germany
    'WAU': 'Audi', 'WBA': 'BMW', 'WBS': 'BMW M', 'WDB': 'Mercedes-Benz', 'WDC': 'Mercedes-Benz', 'WDD': 'Mercedes-Benz', 'WMW': 'MINI', 'W0L': 'Opel', 'WVG': 'Volkswagen', 'WVW': 'Volkswagen', 'WP0': 'Porsche', 'WP1': 'Porsche',
    // Sweden
    'YV1': 'Volvo Cars', 'YV4': 'Volvo Cars', 'YS3': 'Saab',
    // UK
    'SAJ': 'Jaguar', 'SAL': 'Land Rover', 'SCC': 'Lotus Cars', 'SCA': 'Rolls Royce', 'SCB': 'Bentley',
    // Italy
    'ZAR': 'Alfa Romeo', 'ZAM': 'Maserati', 'ZFA': 'Fiat', 'ZFF': 'Ferrari', 'ZHW': 'Lamborghini',
    // France
    'VF1': 'Renault', 'VF3': 'Peugeot', 'VF7': 'Citroën',
    // South Korea
    'KNA': 'Kia', 'KNB': 'Kia', 'KNC': 'Kia', 'KNH': 'Hyundai', 'KNM': 'Hyundai',
    // USA (for completeness)
    '1G': 'General Motors', '1GC': 'Chevrolet', '1GT': 'GMC', '1C': 'Chrysler', '1F': 'Ford', '4S': 'Subaru', '5YJ': 'Tesla',
};
...
export async function tryDecodeVin(vin) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (data && data.Results && data.Results[0] && data.Results[0].Make && data.Results[0].Make !== "Not Applicable") {
        ...
        console.warn("API call failed. This is expected for non-US cars. Falling back to guessing.", error.message);
    }
